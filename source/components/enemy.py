...
class Goomba(Enemy):
    def __init__(self, x, y_bottom, direction, name, color):
        bright_frame_rect = [(0, 16, 16, 16), (16, 16, 16, 16), (32, 16, 16, 16)]
        dark_frame_rect = [(0, 48, 16, 16), (16, 48, 16, 16), (32, 48, 16, 16)]

        if not color:
            frame_rects = bright_frame_rect
        else:
...
class Koopa(Enemy):
    def __init__(self, x, y_bottom, direction, name, color):
        bright_frame_rect = [(96, 9, 16, 22), (112, 9, 16, 22), (160, 9, 16, 22)]
        dark_frame_rect = [(96, 72, 16, 22), (112, 72, 16, 22), (160, 72, 16, 22)]
